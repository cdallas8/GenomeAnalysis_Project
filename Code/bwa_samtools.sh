...
OUTDIR=/home/chiar/genome_analysis/07_BWA_Samtools_HTseq/Samtools
...
do
bwa mem -t 4 $REF $trimmed${R}_P1.trim.fastq.gz $trimmed${R}_P2.trim.fastq.gz | samtools sort -o $R.sorted.bam
done
